...
def populate():
    ...
    team2 = add_team("Better",course2, user2,"Java, python", "Team for Programming project")
    team3 = add_team("Great",course2, user3,"Java, python", "Team for Programming project")
